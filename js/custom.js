...
$(document).ready(function(){
    $("#showboxa").hover(function(){
		$("#showboxa span").slideToggle("slow");
		 $("#showboxa h5").animate({ 
			"margin-top":"-10px",
			"line-height":"30px",
		 }); 
	});
	$("#showboxa").mouseleave(function(){
		 $("#showboxa h5").animate({ 
			"line-height":"120px",
		 }); 
	});
	...
	$("#showboxb").hover(function(){
		$("#showboxb span").slideToggle("slow");
		$("#showboxb h5").animate({ 
			"margin-top":"-10px",
			"line-height":"30px",
		 }); 
	});
	$("#showboxb").mouseleave(function(){
		$("#showboxb h5").animate({ 
		   "line-height":"120px",
		}); 
   });
	...
	$("#showboxc").hover(function(){
		$("#showboxc span").slideToggle("slow");
		$("#showboxc h5").animate({ 
			"margin-top":"-10px",
			"line-height":"30px",
		 }); 
	});
	$("#showboxc").mouseleave(function(){
		$("#showboxc h5").animate({ 
		   "line-height":"120px",
		}); 
   });
	...
	$("#showboxd").hover(function(){
		$("#showboxd span").slideToggle("slow");
		$("#showboxd h5").animate({ 
			"margin-top":"-10px",
			"line-height":"30px",
		 }); 
	});
	$("#showboxd").mouseleave(function(){
		$("#showboxd h5").animate({ 
		   "line-height":"120px",
		}); 
   });
